...
export const Home: React.FC = () => {
    ...
    const { loading, error, data, refetch } = useQuery<{ episodes: {info: InfoProps; results: EpisodeProps[]; }}>(GET_EPISODES, {
        variables: {
            page: page
        }
    });
    ...
    return (
        <div className="min-h-screen flex flex-col bg-gradient-to-b from-[#A3D5E0] to-[#f4f4f4] text-gray-800">
            <header className="bg-[#4ca1af] text-white py-6 text-center shadow-md">
                ...
                <p className="mt2 text-lg italic">Explore multiverse of adventures</p>
            </header>
